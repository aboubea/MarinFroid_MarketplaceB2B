...
export const brandingSettings = pgTable("branding_settings", {
  ...
  authImageZoom: integer("auth_image_zoom").notNull().default(100),
  authImagePositionX: integer("auth_image_position_x").notNull().default(50),
  authImagePositionY: integer("auth_image_position_y").notNull().default(50),
